...
init -1 python hide:
    ...
    ## cheat using developer tools. TODO
    ...
    config.window_title = u"TwitchDatesPokemon"
    
    # This is also the image that appears in the Dock and application switcher
    # in OS X, so consider making it at least 256x256 with a transparent background.
    config.window_icon = "icon.png"

    # These control the name and version of the game, that are reported
    # with tracebacks and other debugging logs.
    config.name = "TwitchDatesPokemon"
    config.version = "0.0"
    ...
    theme.regal(
        ...
        # TODO Make still image placeholder just in case animation fails.
        mm_root = "mm",
    ...
    #Dialogue box thing
    style.window.background = Frame("assets/menu/textbox.png", 0, 0)

    ## Margin is space surrounding the window, where the background
    ## is not drawn.
    
    # Pokeball Selector as Text box
    #style.window.left_margin = 100
    #style.window.right_margin = 100
    #style.window.top_margin = 0
    #style.window.bottom_margin = 6
    
    # Old style menu as text box
    style.window.left_margin = 100
    style.window.right_margin = 100
    style.window.top_margin = 0
    style.window.bottom_margin = 6
    ...
    #character name box test TODO
    style.say_who_window.background = Frame("assets/menu/namebox.png", 0, 0)
    style.say_label.background = Frame("assets/menu/namebox.png", 0, 0)
    
    
    style.say_who_window.left_padding = 50
    style.say_who_window.right_padding = 50
    ...
    config.voice_filename_format = "assets/voices/{filename}.mp3"
    ...
    config.main_menu_music = "assets/music/intro_theme.mp3"
...
python early:
    config.save_directory = "TwitchDatesPokemonDemo-10082014"
...
init -1 python hide:
    ...
    #Button stuff
    #TODO: Need a regular and hoverover background for the choice selector
    ...
    # TWITCH PLAYS Keymaping - For Stream use only!
    #config.keymap['bar_activate'].append('a')
    #config.keymap['button_select'].append('a')
    #config.keymap['input_enter'].append('a') This one in particular will interfere with the console.
    #config.keymap['dismiss'].append('a')
...
init python:
    ...
    build.directory_name = "TwitchDatesPokemonDemo-0.1"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "TwitchDatesPokemonDemo"
